...
@section('content')
          ...
          <div class="widget-title"> <span class="icon"> <i class="icon-info-sign"></i> </span></div></div>
...
<!--End-Action boxes-->    
 ...
 <section id="hero" class="d-flex flex-column justify-content-center align-items-center"> 
    ...
    <div class="container"data-aos="fade-in">
      <span class="text1"><center><strong><i> Welcome To</i></strong></center></font></h1><br></span>
            ...
            <div class="chat-users panel-right2">
              ...
              <div class="panel-content nopadding">
                <ul class="contact-list">
                  ...
                  <li id="user-Linda"><a href=""><img alt="" src="{{ asset('admin/img/demo/av2.jpg') }}" /> <span>Linda</span></a></li>
